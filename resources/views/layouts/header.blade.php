        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../index.html">Auto Provisioning</a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info">
                                    <h5 class="mb-0 text-white nav-user-name">
                                                {{ Auth::user()->name }}</h5>
                                   <span class="ml-2">Last Login : {{ Auth::user()->last_login_at }}</span>
                                </div>
                                <a class="dropdown-item" href="{{ url('profile') }}"><i class="fas fa-user mr-2"></i>Account</a>
                                <a class="dropdown-item" href="{{ url('change-passsword') }}" onclick="goToPage('panel/user/setting')"><i class="fas fa-cog mr-2"></i>Setting</a>
