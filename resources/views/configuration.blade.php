                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('panel/dashboard') }}"
                                    class="breadcrumb-link page">Dashboard</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <!--<button class="btn btn-warning" onclick="refreshDatatable('DatatableConfiguration')"> <i class="fas fa-sync"></i> Refresh </button>-->
                                <a class="btn btn-primary page" href="{{ url('panel/configuration/form') }}"> <i
                                        class="fas fa-plus-circle"></i> Buat Konfigurasi </a>
                            </div>
                            <div class="card-body">
